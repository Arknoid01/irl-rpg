...
| `docs/ROADMAP.md` | Feuille de route suivable (les 2 analyses réconciliées avec l'état du code) |
| `docs/IRL_RPG_Analyse_Modele_Economique_et_Roadmap.md` | Analyse produit / éco / rétention (source) |
| `docs/IRL_RPG_Analyse_Interface_UX.md` | Analyse interface / hiérarchie / présentation (source) |
